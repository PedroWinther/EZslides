...
<form class="form" method="post">
  <div class="title">Bem vindo,<br><span>entre em sua conta</span></div>
  <input class="input" name="username" placeholder="nome de usuario" type="text">
  <input class="input" name="password" placeholder="senha" type="password">
  ...
  <button class="button-confirm" type="submit" name="login">Let`s go →</button>
  <a href="../cadastro/cadastro.php">Não tem uma conta?</a>
</form>
</body>
</html>
